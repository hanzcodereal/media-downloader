...
export default function Home() {
  ...
  const handleDirectDownload = async (mediaUrl: string, label: string) => {
    ...
    try {
      console.log(`[Download] Starting download for: ${mediaUrl}`);
      
      // Gunakan method PUT untuk download file
          ...
          >
            ...
            >
              ...
              <p className="text-[16px] font-normal leading-[25px] mb-[32px] text-[#FFFFFF]/80">
                Support HANZZ CODEE development through Saweria. Your contribution helps us maintain and improve this tool.
              </p>
